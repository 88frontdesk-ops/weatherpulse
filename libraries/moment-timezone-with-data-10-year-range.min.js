!(function (a, i) {
  ...
  function g() {
    for (
      var a,
        ...
        r = new d(new Date(e, 0, 1)),
        o = [r],
        A = 1;
      A < 48;
      A++
    )
      ((i = new d(new Date(e, A, 1))).offset !== r.offset &&
        ((a = (function (a, i) {
          for (var e, r; (r = 6e4 * (((i.at - a.at) / 12e4) | 0)); )
            (e = new d(new Date(a.at + r))).offset === a.offset
              ? (a = e)
              : (i = e);
          return a;
        })(r, i)),
        o.push(a),
        o.push(new d(new Date(a.at + 6e4)))),
        (r = i));
    for (A = 0; A < 4; A++)
      (o.push(new d(new Date(e + A, 0, 1))),
        o.push(new d(new Date(e + A, 6, 1))));
    return o;
  }
  function E(a, i) {
  ...
  function z() {
    ...
    for (
      var e,
        ...
        A = o.length,
        c = (function (a) {
          for (var i, e, r = a.length, o = {}, A = [], c = 0; c < r; c++)
            for (i in (e = u[a[c].offset] || {}))
              e.hasOwnProperty(i) && (o[i] = !0);
  ...
  function S(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++)
      ((o = P((e = (r = a[i].split("|"))[0]))),
        ...
        (function (a, i) {
          var e, r;
          for (l(i), e = 0; e < i.length; e++)
            ((r = i[e]), (u[r] = u[r] || {}), (u[r][a] = !0));
        })(o, r[2].split(" ")));
  }
  function T(a, i) {
    a = P(a);
    ...
    return r instanceof M
      ...
      : "string" == typeof r
        ? ((r = new M(r)), (c[a] = r))
        : n[a] && i !== T && (e = T(n[a], T))
          ? ((r = c[a] = new M())._set(e), (r.name = s[a]), r)
          : null;
  }
  function _(a) {
    var i, e, r, o;
  ...
  function O(a) {
    ...
    return (
      r && !A.isMoment(a) && C(o) && o.add(r.parse(o), "minutes"),
      o.tz(e),
      o
    );
  }
      ...
      parse: function (a) {
        for (
          ...
          if (
            ...
            (e = A[t + 1]),
            (r = A[t ? t - 1 : t]),
            i < e && O.moveAmbiguousForward
              ? (i = e)
              : r < i && O.moveInvalidForward && (i = r),
            o < c[t] - 6e4 * i)
          )
            return A[t];
        return A[n];
  ...
  ((A.tz = O),
    ...
    (A.updateOffset = function (a, i) {
      ...
      (void 0 === a._z &&
        (o &&
          C(a) &&
          !a._isUTC &&
          ((a._d = A.utc(a._a)._d), a.utc().add(o.parse(a), "minutes")),
        (a._z = o)),
        a._z &&
          ((r = a._z.utcOffset(a)),
          Math.abs(r) < 16 && (r /= 60),
          void 0 !== a.utcOffset
            ? ((e = a._z), a.utcOffset(-r, i), (a._z = e))
            : a.zone(r, i)));
    }),
    (L.tz = function (a, i) {
      if (a) {
    ...
    (L.zoneName = D(L.zoneName)),
    (L.zoneAbbr = D(L.zoneAbbr)),
    (L.utc = v(L.utc)),
    (L.local = v(L.local)),
    (L.utcOffset =
      ((N = L.utcOffset),
