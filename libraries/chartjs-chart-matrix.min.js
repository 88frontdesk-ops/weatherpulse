...
!(function (t, e) {
  ...
  class r extends e.DatasetController {
    ...
    static defaults = {
      ...
      animations: {
        numbers: { type: "number", properties: ["x", "y", "width", "height"] },
      },
    };
    static overrides = {
      interaction: { mode: "nearest", intersect: !0 },
      scales: {
        x: { type: "linear", offset: !0 },
        y: { type: "linear", reverse: !0 },
      },
    };
    initialize() {
    ...
    updateElements(t, e, i, r) {
      const s = this,
        a = "reset" === r,
        { xScale: h, yScale: l } = s._cachedMeta,
        d = s.resolveDataElementOptions(e, r),
        c = s.getSharedOptions(r, t[e], d);
      for (let d = e; d < e + i; d++) {
        const e = !a && s.getParsed(d),
          i = a ? h.getBasePixel() : h.getPixelForValue(e.x),
          c = a ? l.getBasePixel() : l.getPixelForValue(e.y),
          u = s.resolveDataElementOptions(d, r),
          { width: g, height: p, anchorX: f, anchorY: x } = u,
          y = { x: n(f, i, g), y: o(x, c, p), width: g, height: p, options: u };
  ...
  function s(t, e) {
    const { x: i, y: r, width: n, height: o } = t.getProps(
      ["x", "y", "width", "height"],
      e
    );
        ...
        return (
          i.isObject(n)
            ? ((o = +n.top || 0),
              ...
              (l = +n.left || 0))
            : (o = s = h = l = +n || 0),
          { t: a(o, 0, r), r: a(s, 0, e), b: a(h, 0, r), l: a(l, 0, e) }
        );
      })(t, r / 2, n / 2);
    return {
      outer: { x: e.left, y: e.top, w: r, h: n },
      inner: {
        x: e.left + o.l,
        y: e.top + o.t,
        w: r - o.l - o.r,
  ...
  class d extends e.Element {
    ...
    getCenterPoint(t) {
      const { x: e, y: i, width: r, height: n } = this.getProps(
        ["x", "y", "width", "height"],
        t
      );
